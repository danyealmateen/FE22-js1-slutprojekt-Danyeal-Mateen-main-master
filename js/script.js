  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      data.photos.photo.forEach((obj) => {
        divForThePictures.innerHTML += `<img id="images" src="https://live.staticflickr.com/${obj.server}/${obj.id}_${obj.secret}_${radioButtonValue}.jpg"/>`;
      });
      console.log(data);
    })
...
downloadButton.addEventListener("click", (e) => {
  e.preventDefault();
  downloadURL();
  console.log("Hej du har klickat download");
});
